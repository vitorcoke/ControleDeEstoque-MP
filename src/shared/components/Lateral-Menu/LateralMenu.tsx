import { Box, Collapse, Divider, Drawer, List, ListItemButton, ListItemIcon, ListItemText, useMediaQuery, useTheme } from '@mui/material';
...
const LateralMenu: React.FC = ({ children }) => {
  ...
  return (
    <>
      <Drawer open={isDrawer} variant={smDown ? 'temporary' : 'permanent'} onClose={toogleDrawer}>
        <Box
        ...
        >
          ...
          >
            <img
              src='https://minhaportaria.com/wp-content/uploads/2021/01/logo-footer-203120.png'
            />
          </Box>
          <Divider />
          <Box flex={1}>
            <List component='nav'>
              ...
              <ListItemButton onClick={handleClickCampinas}>
                ...
                {openCampinas ? <Icon>expand_less</Icon> : <Icon>expand_more</Icon>}
              </ListItemButton>
